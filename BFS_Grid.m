...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %% move to up 
        if u
            [temp] = U_BFS(ary,n,map,Visited_Frontier);
            if temp
        ...
        if u ==0 && l
            [temp] = L_BFS(ary,n,map,Visited_Frontier);
            if temp
                Visited_Frontier =temp;
            else
                l=0;
        ...
        if u == 0 && l == 0
        [Visited_Frontier] = R_BFS(ary,n,map,Visited_Frontier);
        
        
        %if Visited_Frontier == 0
        %    [Visited_Frontier] = check(ary,n,map,2);
        %end
